...
class LoadMessage extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <span id="message-id">Things are loading, {loadedCount} Labels modified</span>
...
const mapState = state => ({
    loadedCount: state.labelsEdit.loadedCount,

    iterateTotal: state.labelsEdit.iterateTotal,
    iterateCurrent: state.labelsEdit.iterateCurrent,
});
