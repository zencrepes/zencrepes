...
export default {
    state: {
        facets: [ // Statically define facets to be displayed
            ...
            {header: 'Created Since', group: 'createdSince', nested: false, data: [] },
            {header: 'Last updated Since', group: 'updatedSince', nested: false, data: [] },
            {header: 'Closed Since', group: 'closedSince', nested: false, data: [] },
        ],
        filters: {},
        results: [],
        mongoFilters: null,
