...
class NoData extends Component {
    ...
    clearQuery = () => {
        ...
        setUpdateQuery({});
        setUpdateQueryPath('/repositories/stats');
    };
        ...
        return (
            <React.Fragment>
                ...
                >
                    ...
                    {!_.isEmpty(query) ? (
                        <React.Fragment>
                            <span>No repositories found, try clearing your query</span><br />
                            <Button
                        ...
                        <React.Fragment>
                            <span>No Repositories in memory</span><br />
                            <Button
...
const mapDispatch = dispatch => ({
    ...
    setLoadRepos: dispatch.repositoriesFetch.setLoadRepos,
