...
class ProtectedBranchesPresent extends Component {
    ...
    render() {
        ...
        return (
            <CustomCard
                headerTitle="With Protected Branches"
                headerFactTitle=""
                headerFactValue=""
            ...
            >
                {statsBranchProtectionPresent.length > 0 ? (
                    <RepositoriesPie
                        dataset={statsBranchProtectionPresent}
                    />
                ): (
...
const mapState = state => ({
    statsBranchProtectionPresent: state.repositoriesView.statsBranchProtectionPresent,
});

export default connect(mapState, null)(ProtectedBranchesPresent);
