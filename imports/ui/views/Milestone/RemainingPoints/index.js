...
class RemainingPoints extends Component {
    ...
    render() {
        const { assigneesRemaining, issues, defaultPoints } = this.props;
        ...
        const repartitionAssignees = assigneesRemaining.map((assignee) => {
...
RemainingPoints.propTypes = {
    assigneesRemaining: PropTypes.array.isRequired,
