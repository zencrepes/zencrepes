            ...
            <div className={classes.root}>
                <Card>
                    <CardContent className={classes.cardContent} >
                        ...
                        <Typography>
                            Please note that this process can be lengthy.
                        </Typography>
                ...
                <Snackbar
                    ...
                    message={<span id="message-id">Created {createdLabels} repositories amongst {updatedRepos} GitHub repositories</span>}
                />
            </div>
        );
    }
