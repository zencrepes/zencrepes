...
class RepositoriesTable extends Component {
    ...
    render() {
        ...
        if (pagination === true) {
            emptyRows = rowsPerPage - Math.min(rowsPerPage, filteredRepositories.length - page * rowsPerPage);
            repositories = filteredRepositories.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage);
